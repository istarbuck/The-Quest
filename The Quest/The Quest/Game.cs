...
namespace The_Quest
{
    public class Game :  IDirection
    {
        ...
        public void IncreasedPlayerHealth(int health, Random random)
        {
        ...
        {
            player.PlayerAttack(direction, random);
            foreach (Enemy enemy in Enemies)
                enemy.Move(random);
        }
            ...
            switch (level)
            {
                ...
                case 4:
                    ...
                    if (!CheckPlayerInventory("Bow")) 
                        WeaponInRoom = new Bow(this, GetRandomLocation(random));
                    else if ((CheckPlayerInventory("Bow")) && (!CheckPlayerInventory("BluePotion")))
                        WeaponInRoom = new BluePotion(this, GetRandomLocation(random));
                    break;
                case 5:
                    Enemies = new List<Enemy>();
                ...
                case 7:
                    ...
                    if (!CheckPlayerInventory("Mace")) 
                        WeaponInRoom = new Mace(this, GetRandomLocation(random));
                    else if ((CheckPlayerInventory("Bow")) && (!CheckPlayerInventory("RedPotion")))
                        WeaponInRoom = new RedPotion(this, GetRandomLocation(random));
                    break;
